        ...
        {Object.entries(colorPalette).map(([name, colorSet]) => (
          <div key={name} className="border rounded p-4">
            ...
            <div className="flex flex-col gap-2">
              <div className={`p-2 rounded ${colorSet.light.bg} ${colorSet.light.text}`}>
                Light Mode Sample
              </div>
              <div className={`p-2 rounded ${colorSet.dark.bg} ${colorSet.dark.text}`}>
                Dark Mode Sample
              </div>
            </div>
          </div>
